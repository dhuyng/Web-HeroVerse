<div class="container-xxl bg-white p-0 ">
    <div class="container-xxl position-relative m-0 p-0 bg-dark">
        <div class="row bg-dark hero-header m-0 p-0">
            <div class="col text-center m-0 p-0 bg-dark">
    ...
    <div class="container-xxl pt-5 pb-3 bg-dark">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="section-title text-center text-primary fw-bold">GIỚI THIỆU</h5>
            </div>
    ...
    <div class="container-xxl pt-5 pb-3">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h5 class="section-title  text-center text-primary fw-bold">THÀNH VIÊN</h5>
            </div>
            <div class="row g-4">
