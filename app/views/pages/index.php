...
<div class="container-xxl bg-white p-0" >
    <!-- Welcome Section -->
    <!-- Bắt đầu Carousel -->
    <div id="heroCarousel" class="carousel slide container-xxl py-0 bg-dark hero-header p-0 wow fadeInLeft" data-bs-ride="carousel">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" >
                    <h1 class="display-5 mb-4">About <i> HeroVerse </i></h1>
                    <p class="mb-4">HeroVerse mở ra một thế giới phiêu lưu kỳ ảo, nơi người chơi sẽ hóa thân thành những anh hùng huyền thoại, chiến đấu chống lại các thế lực bóng tối và khám phá những vùng đất bí ẩn. Với đồ họa sống động và gameplay lôi cuốn, HeroVerse hứa hẹn mang đến trải nghiệm đầy thách thức và hấp dẫn cho các game thủ.</p>
    ...
    <div class="container-xxl pb-3" style="background-image: \url(public/img/background/bg-0.jpg">
        <div class="row text-center">
            ...
            <h2 class="display-5 text-white col-12 g-5 wow fadeInUp">
                HEROES  <!-- Để con trỏ vào GamePlay để chạy hiệu ứng !-->
            </h2>
        </div>
        <div class="row text-center g-5">
            <div class="col-12 text-center">
                
                <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="300">
                    <div class="carousel-inner">
                        <!-- Slide 1 -->
                        <div class="carousel-item active">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center">
                <h1 class="display-5 mb-5">Events</h1>
            </div>
            <div class="row g-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="pricing-plan bg-white text-center" style="min-height: 400px;">
                        ...
                        <br>
                        <a href="" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideỈnight fw-bold">Unlock Now</a>
                    </div>
                </div>
